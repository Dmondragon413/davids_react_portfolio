...
constructor(props) {
         ...
         this.state = {
             ...
             logo: "",
             editMode: false,
             apiUrl: "https://davidmondragon.devcamp.space/portfolio/portfolio_items",
             apiAction: 'post'
         }
         ...
         // one of the main reasons why we use REFs is to clear out form data..
     ...
     componentDidUpdate() {
         if (Object.keys(this.props.portfolioToEdit).length > 0) {
             ...
             this.setState({
                 ...
                 category: category || "Super Fly",
                 url: url || "",
                 position: position || "",
                 editMode: true,
                 apiUrl: `https://davidmondragon.devcamp.space/portfolio/portfolio_items/${id}`,
                 apiAction: "patch",
